...
smpdb.met <- data.frame(Pathway.Name = c("Alanine Metabolism", "Aspartate Metabolism", "Aspartate Metabolism", 
    "Refsum Disease"), Pathway.Type = c("Metabolic", "Metabolic", "Metabolic", "Disease"), ChEBI.ID = c("15956", 
    "15366", "16027", "15351"), stringsAsFactors = FALSE)
smpdb.prot <- data.frame(Pathway.Name = c("Alanine Metabolism", "Aspartate Metabolism", "Aspartate Metabolism", 
    "Primary Hyperoxaluria Type"), Pathway.Subject = c("Metabolic", "Metabolic", "Metabolic", "Disease"), Gene.Name = c("AARS", 
    "ABAT", "ASL", "AARS"), stringsAsFactors = FALSE)
