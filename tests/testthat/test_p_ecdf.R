...
test_that("alternatives", {
  ...
  expect_gte(pe1[1, "pv"], 0.99)
  expect_lte(pe1[2, "pv"], 0.01)
  expect_lte(pe1[3, "pv"], 0.7)
  expect_gte(pe1[3, "pv"], 0.3)

  pe2 <- p_ecdf(eval.v, score.mat, alternative = "less")
  expect_gte(pe2[2, "pv"], 0.99)
  expect_lte(pe2[1, "pv"], 0.01)
  expect_lte(pe2[3, "pv"], 0.7)
  expect_gte(pe2[3, "pv"], 0.3)
  
  pe3 <- p_ecdf(eval.v, score.mat)
  expect_lte(pe3[1, "pv"], 0.01)
  expect_lte(pe3[2, "pv"], 0.01)
  expect_gte(pe3[3, "pv"], 0.9)
})