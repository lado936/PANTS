...
test_that("alternative", {
    ...
    ppl <- plot_pwy(gr = gr, ker = kk, Gmat = G, pwy = "pwy1", score.v = score.v, name = NA, alternative = "less", 
        ntop = 2)
    ...
    ppg <- plot_pwy(gr = gr, ker = kk, Gmat = G, pwy = "pwy1", score.v = score.v, name = NA, alternative = "greater", 
        ntop = 2)
